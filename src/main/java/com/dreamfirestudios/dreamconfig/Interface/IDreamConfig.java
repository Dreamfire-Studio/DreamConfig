...
public interface IDreamConfig {
    ...
    default <T extends IDreamConfig> void DisplayDreamConfig(Consumer<T> onSuccess, DreamMessageSettings dreamMessageSettings) {
        DreamConfigAPI.DisplayDreamConfig((T) this, onSuccess, dreamMessageSettings);
    }
